/*
  ...
  - The values [Draft,Posted] on the enum `PostStatus` will be removed. If these variants are still used in the database, this will fail.
...
ALTER TABLE "Post" ALTER COLUMN "status" SET DEFAULT 'posted';
COMMIT;
